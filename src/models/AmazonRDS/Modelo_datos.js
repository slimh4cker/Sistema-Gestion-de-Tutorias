...
modelo_asesorias.hasMany(modelo_mensajes, { foreignKey: 'id_asesoria', sourceKey: 'id'});

modelo_mensajes.belongsTo(modelo_asesorias, { foreignKey: 'id_asesoria',targetKey: 'id'});
